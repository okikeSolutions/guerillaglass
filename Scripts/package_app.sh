...
INFO_PLIST_SOURCE="$ROOT/app/Info.plist"
if [[ -f "$INFO_PLIST_SOURCE" ]]; then
  ...
  /usr/libexec/PlistBuddy -c "Set :CFBundleExecutable ${APP_NAME}" "$APP/Contents/Info.plist" || true
  /usr/libexec/PlistBuddy -c "Set :CFBundleName ${APP_NAME}" "$APP/Contents/Info.plist" || true
  /usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString ${MARKETING_VERSION}" "$APP/Contents/Info.plist" || true
  /usr/libexec/PlistBuddy -c "Set :CFBundleVersion ${BUILD_NUMBER}" "$APP/Contents/Info.plist" || true
  /usr/libexec/PlistBuddy -c "Set :LSMinimumSystemVersion ${MACOS_MIN_VERSION}" "$APP/Contents/Info.plist" || true
else
...
APP_RESOURCES_DIR="$ROOT/app/Resources"
...
DEFAULT_ENTITLEMENTS="$ROOT/app/Entitlements.entitlements"
