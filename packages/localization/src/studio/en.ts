...
export const enUS = {
  ...
  labels: {
    ...
    status: "Status",
    duration: "Duration",
    sourceDroppedFrames: "Source Drops",
    writerDroppedFrames: "Writer Drops",
    writerBackpressureDrops: "Writer Backpressure",
    achievedFps: "Achieved FPS",
    captureCallback: "Capture Callback",
    recordQueueLag: "Record Queue Lag",
    writerAppend: "Writer Append",
    cpuUsage: "CPU",
    memoryUsage: "Memory",
