    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ActionResult".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    _ => return std::result::Result::Err("Unexpected key while parsing ActionResult".to_string())
                }
            }
        ...
        std::result::Result::Ok(ActionResult {
            success: intermediate_rep.success.into_iter().next().ok_or_else(|| "success missing in ActionResult".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<ActionResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ActionResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ActionResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ActionResult as std::str::FromStr>::from_str(value) {
                        ...
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ActionResult - {err}"#))
                    }
             },
...
impl std::fmt::Display for AgentApplyPayload {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.destructive_intent.as_ref().map(|destructive_intent| {
                [
...
impl std::str::FromStr for AgentApplyPayload {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AgentApplyPayload".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "destructiveIntent" => intermediate_rep.destructive_intent.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AgentApplyPayload".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<AgentApplyPayload>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AgentApplyPayload>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for AgentApplyPayload - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AgentApplyPayload as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into AgentApplyPayload - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::fmt::Display for AgentPreflightPayload {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.runtime_budget_minutes.as_ref().map(|runtime_budget_minutes| {
                [
            ...
            self.transcription_provider.as_ref().map(|transcription_provider| {
                [
            ...
            self.imported_transcript_path.as_ref().map(|imported_transcript_path| {
                [
...
impl std::str::FromStr for AgentPreflightPayload {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AgentPreflightPayload".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "runtimeBudgetMinutes" => intermediate_rep.runtime_budget_minutes.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    ...
                    #[allow(clippy::redundant_clone)]
                    "importedTranscriptPath" => intermediate_rep.imported_transcript_path.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AgentPreflightPayload".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<AgentPreflightPayload>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AgentPreflightPayload>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for AgentPreflightPayload - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AgentPreflightPayload as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into AgentPreflightPayload - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl AgentPreflightResult {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(ready: bool, blocking_reasons: Vec<String>, can_apply_destructive: bool, transcription_provider: String, ) -> AgentPreflightResult {
...
impl std::fmt::Display for AgentPreflightResult {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            Some(self.blocking_reasons.iter().map(|x| x.to_string()).collect::<Vec<_>>().join(",")),
            ...
            self.preflight_token.as_ref().map(|preflight_token| {
                [
                    "preflightToken".to_string(),
                    preflight_token.to_string(),
                ].join(",")
            }),
...
impl std::str::FromStr for AgentPreflightResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AgentPreflightResult".to_string())
            };
        ...
        std::result::Result::Ok(AgentPreflightResult {
            ready: intermediate_rep.ready.into_iter().next().ok_or_else(|| "ready missing in AgentPreflightResult".to_string())?,
            blocking_reasons: intermediate_rep.blocking_reasons.into_iter().next().ok_or_else(|| "blockingReasons missing in AgentPreflightResult".to_string())?,
            can_apply_destructive: intermediate_rep.can_apply_destructive.into_iter().next().ok_or_else(|| "canApplyDestructive missing in AgentPreflightResult".to_string())?,
            transcription_provider: intermediate_rep.transcription_provider.into_iter().next().ok_or_else(|| "transcriptionProvider missing in AgentPreflightResult".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<AgentPreflightResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AgentPreflightResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for AgentPreflightResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AgentPreflightResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into AgentPreflightResult - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl AgentQaReport {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(passed: bool, score: models::AgentQaReportScore, coverage: models::AgentQaReportCoverage, ) -> AgentQaReport {
        AgentQaReport {
 passed,
 score,
 coverage,
        ...
        let params: Vec<Option<String>> = vec![
            ...
            self.missing_beats.as_ref().map(|missing_beats| {
                [
                    ...
                    missing_beats.iter().map(|x| x.to_string()).collect::<Vec<_>>().join(","),
                ].join(",")
            }),
...
impl std::str::FromStr for AgentQaReport {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AgentQaReport".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "score" => intermediate_rep.score.push(<models::AgentQaReportScore as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "coverage" => intermediate_rep.coverage.push(<models::AgentQaReportCoverage as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "missingBeats" => return std::result::Result::Err("Parsing a container in this style is not supported in AgentQaReport".to_string()),
                    _ => return std::result::Result::Err("Unexpected key while parsing AgentQaReport".to_string())
                }
            }
        ...
        std::result::Result::Ok(AgentQaReport {
            passed: intermediate_rep.passed.into_iter().next().ok_or_else(|| "passed missing in AgentQaReport".to_string())?,
            score: intermediate_rep.score.into_iter().next().ok_or_else(|| "score missing in AgentQaReport".to_string())?,
            coverage: intermediate_rep.coverage.into_iter().next().ok_or_else(|| "coverage missing in AgentQaReport".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<AgentQaReport>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AgentQaReport>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for AgentQaReport - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AgentQaReport as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into AgentQaReport - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for AgentQaReportCoverage {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AgentQaReportCoverage".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "hook" => intermediate_rep.hook.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "action" => intermediate_rep.action.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "payoff" => intermediate_rep.payoff.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "takeaway" => intermediate_rep.takeaway.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AgentQaReportCoverage".to_string())
                }
            }
        ...
        std::result::Result::Ok(AgentQaReportCoverage {
            hook: intermediate_rep.hook.into_iter().next().ok_or_else(|| "hook missing in AgentQaReportCoverage".to_string())?,
            action: intermediate_rep.action.into_iter().next().ok_or_else(|| "action missing in AgentQaReportCoverage".to_string())?,
            payoff: intermediate_rep.payoff.into_iter().next().ok_or_else(|| "payoff missing in AgentQaReportCoverage".to_string())?,
            takeaway: intermediate_rep.takeaway.into_iter().next().ok_or_else(|| "takeaway missing in AgentQaReportCoverage".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<AgentQaReportCoverage>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AgentQaReportCoverage>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for AgentQaReportCoverage - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AgentQaReportCoverage as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into AgentQaReportCoverage - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for AgentRunPayload {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AgentRunPayload".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    _ => return std::result::Result::Err("Unexpected key while parsing AgentRunPayload".to_string())
                }
            }
        ...
        std::result::Result::Ok(AgentRunPayload {
            preflight_token: intermediate_rep.preflight_token.into_iter().next().ok_or_else(|| "preflightToken missing in AgentRunPayload".to_string())?,
            runtime_budget_minutes: intermediate_rep.runtime_budget_minutes.into_iter().next(),
            transcription_provider: intermediate_rep.transcription_provider.into_iter().next(),
            imported_transcript_path: intermediate_rep.imported_transcript_path.into_iter().next(),
...
impl std::convert::TryFrom<header::IntoHeaderValue<AgentRunPayload>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AgentRunPayload>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for AgentRunPayload - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AgentRunPayload as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into AgentRunPayload - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for AgentRunResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AgentRunResult".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    _ => return std::result::Result::Err("Unexpected key while parsing AgentRunResult".to_string())
                }
            }
        ...
        std::result::Result::Ok(AgentRunResult {
            job_id: intermediate_rep.job_id.into_iter().next().ok_or_else(|| "jobId missing in AgentRunResult".to_string())?,
            status: intermediate_rep.status.into_iter().next().ok_or_else(|| "status missing in AgentRunResult".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<AgentRunResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AgentRunResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for AgentRunResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AgentRunResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into AgentRunResult - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl AgentRunSummary {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(job_id: String, status: String, runtime_budget_minutes: i32, updated_at: String, ) -> AgentRunSummary {
        AgentRunSummary {
 job_id,
 status,
...
impl std::str::FromStr for AgentRunSummary {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AgentRunSummary".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "runtimeBudgetMinutes" => intermediate_rep.runtime_budget_minutes.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "qaReport" => intermediate_rep.qa_report.push(<models::AgentQaReport as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "blockingReason" => intermediate_rep.blocking_reason.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "updatedAt" => intermediate_rep.updated_at.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AgentRunSummary".to_string())
                }
            }
        ...
        std::result::Result::Ok(AgentRunSummary {
            job_id: intermediate_rep.job_id.into_iter().next().ok_or_else(|| "jobId missing in AgentRunSummary".to_string())?,
            status: intermediate_rep.status.into_iter().next().ok_or_else(|| "status missing in AgentRunSummary".to_string())?,
            runtime_budget_minutes: intermediate_rep.runtime_budget_minutes.into_iter().next().ok_or_else(|| "runtimeBudgetMinutes missing in AgentRunSummary".to_string())?,
            qa_report: intermediate_rep.qa_report.into_iter().next(),
            blocking_reason: intermediate_rep.blocking_reason.into_iter().next(),
            updated_at: intermediate_rep.updated_at.into_iter().next().ok_or_else(|| "updatedAt missing in AgentRunSummary".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<AgentRunSummary>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AgentRunSummary>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for AgentRunSummary - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AgentRunSummary as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into AgentRunSummary - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::fmt::Display for CapabilitiesAgent {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.local_only.as_ref().map(|local_only| {
                [
                    "localOnly".to_string(),
...
impl std::str::FromStr for CapabilitiesAgent {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CapabilitiesAgent".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "preflight" => intermediate_rep.preflight.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "run" => intermediate_rep.run.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "status" => intermediate_rep.status.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "apply" => intermediate_rep.apply.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "localOnly" => intermediate_rep.local_only.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "runtimeBudgetMinutes" => intermediate_rep.runtime_budget_minutes.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing CapabilitiesAgent".to_string())
                }
            }
        ...
        std::result::Result::Ok(CapabilitiesAgent {
            preflight: intermediate_rep.preflight.into_iter().next().ok_or_else(|| "preflight missing in CapabilitiesAgent".to_string())?,
            run: intermediate_rep.run.into_iter().next().ok_or_else(|| "run missing in CapabilitiesAgent".to_string())?,
            status: intermediate_rep.status.into_iter().next().ok_or_else(|| "status missing in CapabilitiesAgent".to_string())?,
            apply: intermediate_rep.apply.into_iter().next().ok_or_else(|| "apply missing in CapabilitiesAgent".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<CapabilitiesAgent>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CapabilitiesAgent>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CapabilitiesAgent - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CapabilitiesAgent as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into CapabilitiesAgent - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl CapabilitiesResult {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(protocol_version: String, platform: String, phase: String, capture: models::CapabilitiesResultCapture, recording: models::CapabilitiesResultRecording, export: models::CapabilitiesResultExport, project: models::CapabilitiesResultProject, ) -> CapabilitiesResult {
        CapabilitiesResult {
 protocol_version,
 platform,
 phase,
...
impl std::str::FromStr for CapabilitiesResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CapabilitiesResult".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "protocolVersion" => intermediate_rep.protocol_version.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "platform" => intermediate_rep.platform.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "phase" => intermediate_rep.phase.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "capture" => intermediate_rep.capture.push(<models::CapabilitiesResultCapture as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "recording" => intermediate_rep.recording.push(<models::CapabilitiesResultRecording as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "export" => intermediate_rep.export.push(<models::CapabilitiesResultExport as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "project" => intermediate_rep.project.push(<models::CapabilitiesResultProject as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "agent" => intermediate_rep.agent.push(<models::CapabilitiesAgent as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing CapabilitiesResult".to_string())
                }
            }
        ...
        std::result::Result::Ok(CapabilitiesResult {
            protocol_version: intermediate_rep.protocol_version.into_iter().next().ok_or_else(|| "protocolVersion missing in CapabilitiesResult".to_string())?,
            platform: intermediate_rep.platform.into_iter().next().ok_or_else(|| "platform missing in CapabilitiesResult".to_string())?,
            phase: intermediate_rep.phase.into_iter().next().ok_or_else(|| "phase missing in CapabilitiesResult".to_string())?,
            capture: intermediate_rep.capture.into_iter().next().ok_or_else(|| "capture missing in CapabilitiesResult".to_string())?,
            recording: intermediate_rep.recording.into_iter().next().ok_or_else(|| "recording missing in CapabilitiesResult".to_string())?,
            export: intermediate_rep.export.into_iter().next().ok_or_else(|| "export missing in CapabilitiesResult".to_string())?,
            project: intermediate_rep.project.into_iter().next().ok_or_else(|| "project missing in CapabilitiesResult".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<CapabilitiesResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CapabilitiesResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CapabilitiesResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CapabilitiesResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into CapabilitiesResult - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl CapabilitiesResultCapture {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(display: bool, window: bool, system_audio: bool, microphone: bool, ) -> CapabilitiesResultCapture {
...
impl std::str::FromStr for CapabilitiesResultCapture {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CapabilitiesResultCapture".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "display" => intermediate_rep.display.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "window" => intermediate_rep.window.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "systemAudio" => intermediate_rep.system_audio.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "microphone" => intermediate_rep.microphone.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing CapabilitiesResultCapture".to_string())
                }
            }
        ...
        std::result::Result::Ok(CapabilitiesResultCapture {
            display: intermediate_rep.display.into_iter().next().ok_or_else(|| "display missing in CapabilitiesResultCapture".to_string())?,
            window: intermediate_rep.window.into_iter().next().ok_or_else(|| "window missing in CapabilitiesResultCapture".to_string())?,
            system_audio: intermediate_rep.system_audio.into_iter().next().ok_or_else(|| "systemAudio missing in CapabilitiesResultCapture".to_string())?,
            microphone: intermediate_rep.microphone.into_iter().next().ok_or_else(|| "microphone missing in CapabilitiesResultCapture".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<CapabilitiesResultCapture>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CapabilitiesResultCapture>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CapabilitiesResultCapture - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CapabilitiesResultCapture as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into CapabilitiesResultCapture - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::fmt::Display for CapabilitiesResultExport {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.cut_plan.as_ref().map(|cut_plan| {
                [
                    "cutPlan".to_string(),
                    cut_plan.to_string(),
                ].join(",")
...
impl std::str::FromStr for CapabilitiesResultExport {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CapabilitiesResultExport".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "presets" => intermediate_rep.presets.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "cutPlan" => intermediate_rep.cut_plan.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing CapabilitiesResultExport".to_string())
                }
            }
        ...
        std::result::Result::Ok(CapabilitiesResultExport {
            presets: intermediate_rep.presets.into_iter().next().ok_or_else(|| "presets missing in CapabilitiesResultExport".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<CapabilitiesResultExport>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CapabilitiesResultExport>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CapabilitiesResultExport - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CapabilitiesResultExport as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into CapabilitiesResultExport - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for CapabilitiesResultProject {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CapabilitiesResultProject".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "openSave" => intermediate_rep.open_save.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing CapabilitiesResultProject".to_string())
                }
            }
        ...
        std::result::Result::Ok(CapabilitiesResultProject {
            open_save: intermediate_rep.open_save.into_iter().next().ok_or_else(|| "openSave missing in CapabilitiesResultProject".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<CapabilitiesResultProject>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CapabilitiesResultProject>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CapabilitiesResultProject - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CapabilitiesResultProject as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into CapabilitiesResultProject - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for CapabilitiesResultRecording {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CapabilitiesResultRecording".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "inputTracking" => intermediate_rep.input_tracking.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing CapabilitiesResultRecording".to_string())
                }
            }
        ...
        std::result::Result::Ok(CapabilitiesResultRecording {
            input_tracking: intermediate_rep.input_tracking.into_iter().next().ok_or_else(|| "inputTracking missing in CapabilitiesResultRecording".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<CapabilitiesResultRecording>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CapabilitiesResultRecording>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CapabilitiesResultRecording - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CapabilitiesResultRecording as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into CapabilitiesResultRecording - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for CapturePreviewFrame {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CapturePreviewFrame".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "frameId" => intermediate_rep.frame_id.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "bytesBase64" => intermediate_rep.bytes_base64.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing CapturePreviewFrame".to_string())
                }
            }
        ...
        std::result::Result::Ok(CapturePreviewFrame {
            frame_id: intermediate_rep.frame_id.into_iter().next().ok_or_else(|| "frameId missing in CapturePreviewFrame".to_string())?,
            bytes_base64: intermediate_rep.bytes_base64.into_iter().next().ok_or_else(|| "bytesBase64 missing in CapturePreviewFrame".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<CapturePreviewFrame>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CapturePreviewFrame>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CapturePreviewFrame - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CapturePreviewFrame as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into CapturePreviewFrame - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for CapturePreviewFrameResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CapturePreviewFrameResult".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "frame" => intermediate_rep.frame.push(<models::CapturePreviewFrame as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing CapturePreviewFrameResult".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<CapturePreviewFrameResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CapturePreviewFrameResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CapturePreviewFrameResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CapturePreviewFrameResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into CapturePreviewFrameResult - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::fmt::Display for CaptureStartCurrentWindowPayload {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.enable_mic.as_ref().map(|enable_mic| {
                [
                    "enableMic".to_string(),
                    enable_mic.to_string(),
                ].join(",")
            }),
            ...
            self.enable_preview.as_ref().map(|enable_preview| {
                [
                    "enablePreview".to_string(),
                    enable_preview.to_string(),
                ].join(",")
            }),


            self.capture_fps.as_ref().map(|capture_fps| {
                [
                    "captureFps".to_string(),
...
impl std::str::FromStr for CaptureStartCurrentWindowPayload {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CaptureStartCurrentWindowPayload".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "enableMic" => intermediate_rep.enable_mic.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<CaptureStartCurrentWindowPayload>> for HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<CaptureStartCurrentWindowPayload>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CaptureStartCurrentWindowPayload - value: {hdr_value} is invalid {e}"#))
        }
    }
}

#[cfg(feature = "server")]
impl std::convert::TryFrom<HeaderValue> for header::IntoHeaderValue<CaptureStartCurrentWindowPayload> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CaptureStartCurrentWindowPayload as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into CaptureStartCurrentWindowPayload - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::fmt::Display for CaptureStartDisplayPayload {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.display_id.as_ref().map(|display_id| {
                [
                    "displayId".to_string(),
...
impl std::str::FromStr for CaptureStartDisplayPayload {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CaptureStartDisplayPayload".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "displayId" => intermediate_rep.display_id.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "enableMic" => intermediate_rep.enable_mic.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "enablePreview" => intermediate_rep.enable_preview.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl std::convert::TryFrom<header::IntoHeaderValue<CaptureStartDisplayPayload>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CaptureStartDisplayPayload>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CaptureStartDisplayPayload - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CaptureStartDisplayPayload as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into CaptureStartDisplayPayload - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for CaptureStartWindowPayload {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CaptureStartWindowPayload".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "windowId" => intermediate_rep.window_id.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "enableMic" => intermediate_rep.enable_mic.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "enablePreview" => intermediate_rep.enable_preview.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
        ...
        std::result::Result::Ok(CaptureStartWindowPayload {
            window_id: intermediate_rep.window_id.into_iter().next().ok_or_else(|| "windowId missing in CaptureStartWindowPayload".to_string())?,
            enable_mic: intermediate_rep.enable_mic.into_iter().next(),
            enable_preview: intermediate_rep.enable_preview.into_iter().next(),
            capture_fps: intermediate_rep.capture_fps.into_iter().next(),
        })
...
impl std::convert::TryFrom<header::IntoHeaderValue<CaptureStartWindowPayload>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CaptureStartWindowPayload>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CaptureStartWindowPayload - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CaptureStartWindowPayload as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into CaptureStartWindowPayload - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl CaptureStatusResult {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(is_running: bool, is_recording: bool, recording_duration_seconds: f64, telemetry: models::CaptureTelemetry, ) -> CaptureStatusResult {
        CaptureStatusResult {
 is_running,
 is_recording,
...
impl std::fmt::Display for CaptureStatusResult {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.events_url.as_ref().map(|events_url| {
                [
                    "eventsURL".to_string(),
...
impl std::str::FromStr for CaptureStatusResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CaptureStatusResult".to_string())
            };
        ...
        std::result::Result::Ok(CaptureStatusResult {
            is_running: intermediate_rep.is_running.into_iter().next().ok_or_else(|| "isRunning missing in CaptureStatusResult".to_string())?,
            is_recording: intermediate_rep.is_recording.into_iter().next().ok_or_else(|| "isRecording missing in CaptureStatusResult".to_string())?,
            capture_session_id: intermediate_rep.capture_session_id.into_iter().next(),
            recording_duration_seconds: intermediate_rep.recording_duration_seconds.into_iter().next().ok_or_else(|| "recordingDurationSeconds missing in CaptureStatusResult".to_string())?,
            ...
            telemetry: intermediate_rep.telemetry.into_iter().next().ok_or_else(|| "telemetry missing in CaptureStatusResult".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<CaptureStatusResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CaptureStatusResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CaptureStatusResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CaptureStatusResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into CaptureStatusResult - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for CaptureStatusResultCaptureMetadata {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CaptureStatusResultCaptureMetadata".to_string())
            };
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<CaptureStatusResultCaptureMetadata>> for HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<CaptureStatusResultCaptureMetadata>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CaptureStatusResultCaptureMetadata - value: {hdr_value} is invalid {e}"#))
        }
    }
}

#[cfg(feature = "server")]
impl std::convert::TryFrom<HeaderValue> for header::IntoHeaderValue<CaptureStatusResultCaptureMetadata> {
    type Error = String;
...
impl std::fmt::Display for CaptureTelemetry {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.source_dropped_frames.as_ref().map(|source_dropped_frames| {
                [
            ...
            self.writer_dropped_frames.as_ref().map(|writer_dropped_frames| {
                [
            ...
            self.writer_backpressure_drops.as_ref().map(|writer_backpressure_drops| {
                [
            ...
            self.achieved_fps.as_ref().map(|achieved_fps| {
                [
                    "achievedFps".to_string(),
                    achieved_fps.to_string(),
                ].join(",")
            }),
            ...
            self.recording_bitrate_mbps.as_ref().map(|recording_bitrate_mbps| {
                [
            ...
            self.capture_callback_ms.as_ref().map(|capture_callback_ms| {
                [
            ...
            self.record_queue_lag_ms.as_ref().map(|record_queue_lag_ms| {
                [
            ...
            self.writer_append_ms.as_ref().map(|writer_append_ms| {
                [
                    "writerAppendMs".to_string(),
                    writer_append_ms.to_string(),
                ].join(",")
            }),
            ...
            self.preview_encode_ms.as_ref().map(|preview_encode_ms| {
                [
                    "previewEncodeMs".to_string(),
                    preview_encode_ms.to_string(),
                ].join(",")
            }),
...
impl std::str::FromStr for CaptureTelemetry {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CaptureTelemetry".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "sourceDroppedFrames" => intermediate_rep.source_dropped_frames.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "writerDroppedFrames" => intermediate_rep.writer_dropped_frames.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "writerBackpressureDrops" => intermediate_rep.writer_backpressure_drops.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "achievedFps" => intermediate_rep.achieved_fps.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "cpuPercent" => intermediate_rep.cpu_percent.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "memoryBytes" => intermediate_rep.memory_bytes.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "recordingBitrateMbps" => intermediate_rep.recording_bitrate_mbps.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "captureCallbackMs" => intermediate_rep.capture_callback_ms.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "recordQueueLagMs" => intermediate_rep.record_queue_lag_ms.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "writerAppendMs" => intermediate_rep.writer_append_ms.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "previewEncodeMs" => intermediate_rep.preview_encode_ms.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing CaptureTelemetry".to_string())
                }
            }
        ...
        std::result::Result::Ok(CaptureTelemetry {
            ...
            writer_backpressure_drops: intermediate_rep.writer_backpressure_drops.into_iter().next(),
...
impl std::convert::TryFrom<header::IntoHeaderValue<CaptureTelemetry>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CaptureTelemetry>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for CaptureTelemetry - value: {hdr_value} is invalid {e}"#))
        }
    }
}
...
impl std::str::FromStr for EngineBadRequestError {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing EngineBadRequestError".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "message" => intermediate_rep.message.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing EngineBadRequestError".to_string())
                }
            }
        ...
        std::result::Result::Ok(EngineBadRequestError {
            code: intermediate_rep.code.into_iter().next().ok_or_else(|| "code missing in EngineBadRequestError".to_string())?,
            message: intermediate_rep.message.into_iter().next().ok_or_else(|| "message missing in EngineBadRequestError".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<EngineBadRequestError>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<EngineBadRequestError>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for EngineBadRequestError - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <EngineBadRequestError as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into EngineBadRequestError - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for EngineConflictError {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing EngineConflictError".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "message" => intermediate_rep.message.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing EngineConflictError".to_string())
                }
            }
        ...
        std::result::Result::Ok(EngineConflictError {
            code: intermediate_rep.code.into_iter().next().ok_or_else(|| "code missing in EngineConflictError".to_string())?,
            message: intermediate_rep.message.into_iter().next().ok_or_else(|| "message missing in EngineConflictError".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<EngineConflictError>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<EngineConflictError>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for EngineConflictError - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <EngineConflictError as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into EngineConflictError - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for EngineForbiddenError {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing EngineForbiddenError".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "message" => intermediate_rep.message.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing EngineForbiddenError".to_string())
                }
            }
        ...
        std::result::Result::Ok(EngineForbiddenError {
            code: intermediate_rep.code.into_iter().next().ok_or_else(|| "code missing in EngineForbiddenError".to_string())?,
            message: intermediate_rep.message.into_iter().next().ok_or_else(|| "message missing in EngineForbiddenError".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<EngineForbiddenError>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<EngineForbiddenError>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for EngineForbiddenError - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <EngineForbiddenError as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into EngineForbiddenError - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for EngineNotFoundError {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing EngineNotFoundError".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "message" => intermediate_rep.message.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing EngineNotFoundError".to_string())
                }
            }
        ...
        std::result::Result::Ok(EngineNotFoundError {
            code: intermediate_rep.code.into_iter().next().ok_or_else(|| "code missing in EngineNotFoundError".to_string())?,
            message: intermediate_rep.message.into_iter().next().ok_or_else(|| "message missing in EngineNotFoundError".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<EngineNotFoundError>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<EngineNotFoundError>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for EngineNotFoundError - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <EngineNotFoundError as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into EngineNotFoundError - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for EngineRuntimeError {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing EngineRuntimeError".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "message" => intermediate_rep.message.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing EngineRuntimeError".to_string())
                }
            }
        ...
        std::result::Result::Ok(EngineRuntimeError {
            code: intermediate_rep.code.into_iter().next().ok_or_else(|| "code missing in EngineRuntimeError".to_string())?,
            message: intermediate_rep.message.into_iter().next().ok_or_else(|| "message missing in EngineRuntimeError".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<EngineRuntimeError>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<EngineRuntimeError>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for EngineRuntimeError - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <EngineRuntimeError as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into EngineRuntimeError - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for EngineUnauthorizedError {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing EngineUnauthorizedError".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "message" => intermediate_rep.message.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing EngineUnauthorizedError".to_string())
                }
            }
        ...
        std::result::Result::Ok(EngineUnauthorizedError {
            code: intermediate_rep.code.into_iter().next().ok_or_else(|| "code missing in EngineUnauthorizedError".to_string())?,
            message: intermediate_rep.message.into_iter().next().ok_or_else(|| "message missing in EngineUnauthorizedError".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<EngineUnauthorizedError>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<EngineUnauthorizedError>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for EngineUnauthorizedError - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <EngineUnauthorizedError as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into EngineUnauthorizedError - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for EngineUnprocessableError {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing EngineUnprocessableError".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "message" => intermediate_rep.message.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing EngineUnprocessableError".to_string())
                }
            }
        ...
        std::result::Result::Ok(EngineUnprocessableError {
            code: intermediate_rep.code.into_iter().next().ok_or_else(|| "code missing in EngineUnprocessableError".to_string())?,
            message: intermediate_rep.message.into_iter().next().ok_or_else(|| "message missing in EngineUnprocessableError".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<EngineUnprocessableError>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<EngineUnprocessableError>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for EngineUnprocessableError - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <EngineUnprocessableError as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into EngineUnprocessableError - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for ExportInfoResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ExportInfoResult".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    "presets" => return std::result::Result::Err("Parsing a container in this style is not supported in ExportInfoResult".to_string()),
                    _ => return std::result::Result::Err("Unexpected key while parsing ExportInfoResult".to_string())
                }
            }
        ...
        std::result::Result::Ok(ExportInfoResult {
            presets: intermediate_rep.presets.into_iter().next().ok_or_else(|| "presets missing in ExportInfoResult".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExportInfoResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExportInfoResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ExportInfoResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExportInfoResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ExportInfoResult - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl ExportPreset {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(id: String, name: String, width: i32, height: i32, fps: i32, file_type: String, ) -> ExportPreset {
        ExportPreset {
 id,
 name,
 width,
...
impl std::str::FromStr for ExportPreset {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ExportPreset".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "height" => intermediate_rep.height.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "fps" => intermediate_rep.fps.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "fileType" => intermediate_rep.file_type.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ExportPreset".to_string())
                }
            }
        ...
        std::result::Result::Ok(ExportPreset {
            id: intermediate_rep.id.into_iter().next().ok_or_else(|| "id missing in ExportPreset".to_string())?,
            name: intermediate_rep.name.into_iter().next().ok_or_else(|| "name missing in ExportPreset".to_string())?,
            width: intermediate_rep.width.into_iter().next().ok_or_else(|| "width missing in ExportPreset".to_string())?,
            height: intermediate_rep.height.into_iter().next().ok_or_else(|| "height missing in ExportPreset".to_string())?,
            fps: intermediate_rep.fps.into_iter().next().ok_or_else(|| "fps missing in ExportPreset".to_string())?,
            file_type: intermediate_rep.file_type.into_iter().next().ok_or_else(|| "fileType missing in ExportPreset".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExportPreset>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExportPreset>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ExportPreset - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExportPreset as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ExportPreset - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for ExportRunCutPlanPayload {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ExportRunCutPlanPayload".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "outputURL" => intermediate_rep.output_url.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "presetId" => intermediate_rep.preset_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "jobId" => intermediate_rep.job_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ExportRunCutPlanPayload".to_string())
                }
            }
        ...
        std::result::Result::Ok(ExportRunCutPlanPayload {
            output_url: intermediate_rep.output_url.into_iter().next().ok_or_else(|| "outputURL missing in ExportRunCutPlanPayload".to_string())?,
            preset_id: intermediate_rep.preset_id.into_iter().next().ok_or_else(|| "presetId missing in ExportRunCutPlanPayload".to_string())?,
            job_id: intermediate_rep.job_id.into_iter().next().ok_or_else(|| "jobId missing in ExportRunCutPlanPayload".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExportRunCutPlanPayload>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExportRunCutPlanPayload>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ExportRunCutPlanPayload - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExportRunCutPlanPayload as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ExportRunCutPlanPayload - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::fmt::Display for ExportRunCutPlanResult {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.output_url.as_ref().map(|output_url| {
                [
                    "outputURL".to_string(),
            ...
            self.applied_segments.as_ref().map(|applied_segments| {
                [
                    "appliedSegments".to_string(),
                    applied_segments.to_string(),
                ].join(",")
            }),
...
impl std::str::FromStr for ExportRunCutPlanResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ExportRunCutPlanResult".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "outputURL" => intermediate_rep.output_url.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "appliedSegments" => intermediate_rep.applied_segments.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ExportRunCutPlanResult".to_string())
                }
            }
        ...
        std::result::Result::Ok(ExportRunCutPlanResult {
            job_id: intermediate_rep.job_id.into_iter().next().ok_or_else(|| "jobId missing in ExportRunCutPlanResult".to_string())?,
            status: intermediate_rep.status.into_iter().next().ok_or_else(|| "status missing in ExportRunCutPlanResult".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExportRunCutPlanResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExportRunCutPlanResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ExportRunCutPlanResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExportRunCutPlanResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ExportRunCutPlanResult - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.trim_end_seconds.as_ref().map(|trim_end_seconds| {
                [
                    "trimEndSeconds".to_string(),
                    trim_end_seconds.to_string(),
                ].join(",")
            }),
...
impl std::str::FromStr for ExportRunPayload {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ExportRunPayload".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "presetId" => intermediate_rep.preset_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "trimStartSeconds" => intermediate_rep.trim_start_seconds.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "trimEndSeconds" => intermediate_rep.trim_end_seconds.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    ...
                    _ => return std::result::Result::Err("Unexpected key while parsing ExportRunPayload".to_string())
                }
            }
        ...
        std::result::Result::Ok(ExportRunPayload {
            output_url: intermediate_rep.output_url.into_iter().next().ok_or_else(|| "outputURL missing in ExportRunPayload".to_string())?,
            preset_id: intermediate_rep.preset_id.into_iter().next().ok_or_else(|| "presetId missing in ExportRunPayload".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExportRunPayload>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExportRunPayload>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ExportRunPayload - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExportRunPayload as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ExportRunPayload - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl ExportRunPayloadTimeline {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(version: f64, items: Vec<models::ExportRunPayloadTimelineItemsInner>, ) -> ExportRunPayloadTimeline {
...
impl std::str::FromStr for ExportRunPayloadTimeline {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ExportRunPayloadTimeline".to_string())
            };
        ...
        std::result::Result::Ok(ExportRunPayloadTimeline {
            version: intermediate_rep.version.into_iter().next().ok_or_else(|| "version missing in ExportRunPayloadTimeline".to_string())?,
            items: intermediate_rep.items.into_iter().next().ok_or_else(|| "items missing in ExportRunPayloadTimeline".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExportRunPayloadTimeline>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExportRunPayloadTimeline>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ExportRunPayloadTimeline - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExportRunPayloadTimeline as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ExportRunPayloadTimeline - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for ExportRunResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ExportRunResult".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "outputURL" => intermediate_rep.output_url.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ExportRunResult".to_string())
                }
            }
        ...
        std::result::Result::Ok(ExportRunResult {
            job_id: intermediate_rep.job_id.into_iter().next().ok_or_else(|| "jobId missing in ExportRunResult".to_string())?,
            status: intermediate_rep.status.into_iter().next().ok_or_else(|| "status missing in ExportRunResult".to_string())?,
            output_url: intermediate_rep.output_url.into_iter().next(),
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExportRunResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExportRunResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ExportRunResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExportRunResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ExportRunResult - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl PermissionsResult {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(screen_recording_granted: bool, microphone_granted: bool, input_monitoring: String, ) -> PermissionsResult {
        PermissionsResult {
...
impl std::str::FromStr for PermissionsResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing PermissionsResult".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "screenRecordingGranted" => intermediate_rep.screen_recording_granted.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "microphoneGranted" => intermediate_rep.microphone_granted.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "inputMonitoring" => intermediate_rep.input_monitoring.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing PermissionsResult".to_string())
                }
            }
        ...
        std::result::Result::Ok(PermissionsResult {
            screen_recording_granted: intermediate_rep.screen_recording_granted.into_iter().next().ok_or_else(|| "screenRecordingGranted missing in PermissionsResult".to_string())?,
            microphone_granted: intermediate_rep.microphone_granted.into_iter().next().ok_or_else(|| "microphoneGranted missing in PermissionsResult".to_string())?,
            input_monitoring: intermediate_rep.input_monitoring.into_iter().next().ok_or_else(|| "inputMonitoring missing in PermissionsResult".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<PermissionsResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PermissionsResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for PermissionsResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PermissionsResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into PermissionsResult - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl PingResult {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(app: String, engine_version: String, protocol_version: String, platform: String, ) -> PingResult {
        PingResult {
 app,
 engine_version,
 protocol_version,
...
impl std::str::FromStr for PingResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing PingResult".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "app" => intermediate_rep.app.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "engineVersion" => intermediate_rep.engine_version.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "protocolVersion" => intermediate_rep.protocol_version.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "platform" => intermediate_rep.platform.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing PingResult".to_string())
                }
            }
        ...
        std::result::Result::Ok(PingResult {
            app: intermediate_rep.app.into_iter().next().ok_or_else(|| "app missing in PingResult".to_string())?,
            engine_version: intermediate_rep.engine_version.into_iter().next().ok_or_else(|| "engineVersion missing in PingResult".to_string())?,
            protocol_version: intermediate_rep.protocol_version.into_iter().next().ok_or_else(|| "protocolVersion missing in PingResult".to_string())?,
            platform: intermediate_rep.platform.into_iter().next().ok_or_else(|| "platform missing in PingResult".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<PingResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PingResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for PingResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PingResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into PingResult - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.latest_status.as_ref().map(|latest_status| {
                [
                    "latestStatus".to_string(),
                    latest_status.to_string(),
                ].join(",")
            }),


            self.qa_passed.as_ref().map(|qa_passed| {
                [
                    "qaPassed".to_string(),
                    qa_passed.to_string(),
                ].join(",")
...
impl std::str::FromStr for ProjectAgentAnalysisSummary {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ProjectAgentAnalysisSummary".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "latestJobId" => intermediate_rep.latest_job_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "latestStatus" => intermediate_rep.latest_status.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "qaPassed" => intermediate_rep.qa_passed.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "updatedAt" => intermediate_rep.updated_at.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ProjectAgentAnalysisSummary".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<ProjectAgentAnalysisSummary>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ProjectAgentAnalysisSummary>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ProjectAgentAnalysisSummary - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ProjectAgentAnalysisSummary as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ProjectAgentAnalysisSummary - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for ProjectOpenPayload {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ProjectOpenPayload".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    _ => return std::result::Result::Err("Unexpected key while parsing ProjectOpenPayload".to_string())
                }
            }
        ...
        std::result::Result::Ok(ProjectOpenPayload {
            project_path: intermediate_rep.project_path.into_iter().next().ok_or_else(|| "projectPath missing in ProjectOpenPayload".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ProjectOpenPayload>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ProjectOpenPayload>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ProjectOpenPayload - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ProjectOpenPayload as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ProjectOpenPayload - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl ProjectRecentItem {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(project_path: String, display_name: String, last_opened_at: String, ) -> ProjectRecentItem {
        ProjectRecentItem {
 project_path,
 display_name,
 last_opened_at,
...
impl std::str::FromStr for ProjectRecentItem {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ProjectRecentItem".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "displayName" => intermediate_rep.display_name.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "lastOpenedAt" => intermediate_rep.last_opened_at.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ProjectRecentItem".to_string())
                }
            }
        ...
        std::result::Result::Ok(ProjectRecentItem {
            project_path: intermediate_rep.project_path.into_iter().next().ok_or_else(|| "projectPath missing in ProjectRecentItem".to_string())?,
            display_name: intermediate_rep.display_name.into_iter().next().ok_or_else(|| "displayName missing in ProjectRecentItem".to_string())?,
            last_opened_at: intermediate_rep.last_opened_at.into_iter().next().ok_or_else(|| "lastOpenedAt missing in ProjectRecentItem".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ProjectRecentItem>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ProjectRecentItem>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ProjectRecentItem - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ProjectRecentItem as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ProjectRecentItem - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for ProjectRecentsResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ProjectRecentsResult".to_string())
            };
        ...
        std::result::Result::Ok(ProjectRecentsResult {
            items: intermediate_rep.items.into_iter().next().ok_or_else(|| "items missing in ProjectRecentsResult".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ProjectRecentsResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ProjectRecentsResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ProjectRecentsResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ProjectRecentsResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ProjectRecentsResult - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for ProjectSavePayload {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ProjectSavePayload".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "timeline" => intermediate_rep.timeline.push(<models::ExportRunPayloadTimeline as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ProjectSavePayload".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<ProjectSavePayload>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ProjectSavePayload>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ProjectSavePayload - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ProjectSavePayload as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ProjectSavePayload - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl ProjectState {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(auto_zoom: models::ProjectStateAutoZoom, timeline: models::ExportRunPayloadTimeline, ) -> ProjectState {
        ProjectState {
 project_path: None,
 recording_url: None,
 events_url: None,
...
impl std::str::FromStr for ProjectState {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ProjectState".to_string())
            };
        ...
        std::result::Result::Ok(ProjectState {
            ...
            events_url: intermediate_rep.events_url.into_iter().next(),
            last_recording_telemetry: intermediate_rep.last_recording_telemetry.into_iter().next(),
            auto_zoom: intermediate_rep.auto_zoom.into_iter().next().ok_or_else(|| "autoZoom missing in ProjectState".to_string())?,
            timeline: intermediate_rep.timeline.into_iter().next().ok_or_else(|| "timeline missing in ProjectState".to_string())?,
            capture_metadata: intermediate_rep.capture_metadata.into_iter().next(),
...
impl std::convert::TryFrom<header::IntoHeaderValue<ProjectState>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ProjectState>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ProjectState - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ProjectState as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ProjectState - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl ProjectStateAutoZoom {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(is_enabled: bool, intensity: f64, minimum_keyframe_interval: f64, ) -> ProjectStateAutoZoom {
...
impl std::str::FromStr for ProjectStateAutoZoom {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ProjectStateAutoZoom".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "isEnabled" => intermediate_rep.is_enabled.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "intensity" => intermediate_rep.intensity.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "minimumKeyframeInterval" => intermediate_rep.minimum_keyframe_interval.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ProjectStateAutoZoom".to_string())
                }
            }
        ...
        std::result::Result::Ok(ProjectStateAutoZoom {
            is_enabled: intermediate_rep.is_enabled.into_iter().next().ok_or_else(|| "isEnabled missing in ProjectStateAutoZoom".to_string())?,
            intensity: intermediate_rep.intensity.into_iter().next().ok_or_else(|| "intensity missing in ProjectStateAutoZoom".to_string())?,
            minimum_keyframe_interval: intermediate_rep.minimum_keyframe_interval.into_iter().next().ok_or_else(|| "minimumKeyframeInterval missing in ProjectStateAutoZoom".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ProjectStateAutoZoom>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ProjectStateAutoZoom>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ProjectStateAutoZoom - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ProjectStateAutoZoom as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ProjectStateAutoZoom - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::fmt::Display for RecordingStartPayload {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.track_input_events.as_ref().map(|track_input_events| {
                [
...
impl std::str::FromStr for RecordingStartPayload {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing RecordingStartPayload".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "trackInputEvents" => intermediate_rep.track_input_events.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing RecordingStartPayload".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<RecordingStartPayload>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<RecordingStartPayload>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for RecordingStartPayload - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <RecordingStartPayload as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into RecordingStartPayload - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for SourcesResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing SourcesResult".to_string())
            };
...
impl std::convert::TryFrom<header::IntoHeaderValue<SourcesResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<SourcesResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for SourcesResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
