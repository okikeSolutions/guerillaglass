...
pub enum AgentAgentPreflightResponse {
    ...
    Status200_AgentPreflightResult(models::AgentPreflightResult),
    /// EngineBadRequestError response body.
    Status400_EngineBadRequestErrorResponseBody(models::EngineBadRequestError),
    /// EngineUnauthorizedError response body.
    Status401_EngineUnauthorizedErrorResponseBody(models::AgentAgentPreflight401Response),
...
pub enum AgentAgentRunResponse {
    /// AgentRunResult
    Status200_AgentRunResult(models::AgentRunResult),
    /// EngineBadRequestError response body.
    Status400_EngineBadRequestErrorResponseBody(models::EngineBadRequestError),
    /// EngineUnauthorizedError response body.
    Status401_EngineUnauthorizedErrorResponseBody(models::AgentAgentPreflight401Response),
...
pub enum AgentAgentStatusResponse {
    /// AgentRunSummary
    Status200_AgentRunSummary(models::AgentRunSummary),
    /// EngineBadRequestError response body.
    Status400_EngineBadRequestErrorResponseBody(models::EngineBadRequestError),
    /// EngineUnauthorizedError response body.
    Status401_EngineUnauthorizedErrorResponseBody(models::AgentAgentPreflight401Response),
