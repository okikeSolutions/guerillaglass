...
export const ProductPacks = () => {
  ...
  return (
    <section ref={timelineRef} className="py-24 px-6 bg-black/45 text-black min-h-screen">
      <div className="max-w-4xl mx-auto ">
        <TimelineAnimation animationNum={1} timelineRef={timelineRef} className="text-center mb-12">
          <TimelineAnimation
            animationNum={2}
          ...
          <TimelineAnimation
            ...
            timelineRef={timelineRef}
            as="p"
            className="text-white text-pretty max-w-lg leading-relaxed mx-auto"
          >
            Your product design partner. Unlock instant, world-class design with a simple monthly
            fee.
          </TimelineAnimation>
        </TimelineAnimation>
        <TimelineAnimation
        ...
        >
          ...
          <TimelineAnimation
            animationNum={5}
            timelineRef={timelineRef}
            className="bg-blue-300 border border-neutral-100 rounded-4xl p-10 flex flex-col shadow-sm space-y-6"
          >
            <div className="space-y-2">
              ...
              <p className="text-neutral-800 text-sm">Try Bloom for free to test it in work</p>
            </div>
            ...
            <div className="space-y-4 pt-6 border-t border-yellow-50">
              {[
                ...
                <div key={i} className="flex justify-between items-center">
                  ...
                  <span className="text-sm text-neutral-700 font-semibold">{item.val}</span>
                </div>
              ))}
            </div>
            <Button
          ...
          >
            ...
            <div className="space-y-4 pt-6 border-t border-neutral-800">
              {[
                ...
                <div key={i} className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-neutral-400 ">{item.val}</span>
                </div>
              ))}
            </div>
            ...
            <Button
              variant="outline"
              className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md bg-neutral-50 border-2 border-blue-300 px-6 font-medium text-black transition-all duration-100 shadow-[5px_5px_rgb(255_210_48)] active:translate-x-[3px] active:translate-y-[3px] hover:bg-neutral-100 active:shadow-none "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
