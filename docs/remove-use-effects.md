...
_(Show Details - This section would typically expand with more details, but it's omitted here for brevity)_
...
The analytics POST request should remain in an Effect. This is because the reason to send the analytics event is that the form was displayed. (It would fire twice in development, but see [here](https://react.dev/learn/synchronizing-with-effects#adjusting-some-state-when-a-prop-changes) for how to deal with that.)
...
<!-- Last updated: 2026-02-10 19:47:54 UTC by GitHub Actions (PR #517) -->
